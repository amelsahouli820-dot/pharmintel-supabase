...
const publicPaths = ["/connexion", "/inscription", "/mot-de-passe-oublie", "/identifiant-oublie", "/aide", "/reinitialiser", "/api/auth/login", "/api/auth/register", "/api/auth/recovery/", "/api/auth/support", "/api/health", "/api/public/", "/api/i18n", "/manifest.webmanifest", "/sw.js", "/icons/"];
