...
export const documentMetadataSchema = z.object({
  ...
  region: z.string().trim().max(150).optional().default(""), wilaya: z.string().trim().max(100).optional().default(""), product:z.string().trim().max(300).optional().default(""),priceHt:z.string().optional().default(""),discountPercent:z.string().optional().default(""),ugPercent:z.string().optional().default(""),offerText:z.string().trim().max(50).optional().default(""),offerBuyQty:z.string().optional().default(""),offerFreeQty:z.string().optional().default(""), laboratory: z.string().trim().max(200).optional().default(""),
